...
$(function () {        
		 ...
		 $.ajax({
			...
			var makerName=[];
	        	$.each(data,function(index,list){
	        		$('#resultlist').append("<td>"+list.scode+"::"+list.sgpsX+"</td>"
					//$('#resultlist').append("<td>"+list.sname+"</td>");
					//$('#resultlist').append("<td>"+list.saddr+"</td>");
					//$('#resultlist').append("<td>"+list.stime+"</td>");
					//$('#resultlist').append("<td>"+list.sparking+"</td>");
					//$('#resultlist').append("<td>"+list.sphotoname+"</td>");
					//$('#resultlist').append("<td>"+list.savgScore+"</td>");
					//$('#resultlist').append("<td>"+list.slocale+"</td>");
	...
	function map_load(makerX,makerY,makerName){
		...
		for (a=0;a<makerName.length;a++){
			...
			positions.push({content:'<div>'+makerName+'</div>',
		...
		console.log(positions.length+"11111");
		for (var i = 0; i < positions.length; i ++) {
			console.log(positions.length+"22222");
