...
function search_ajax_filter(){
	...
	var filter = $('#searchFilter').serialize();
	//var filter = $('#searchFilter').serializeArray();
	//var filter_1 = StringEscapeUtils.unescapeHtml(filter);
...
$(function () {      
	...
	/*
	function search_ajax_filter(){
	console.log("요청 받음"+userLocalX+userLocalY);
	var filter = [];
